...
dim(META_data)
#########################removing familial forms of cancer######################
...
head(HIS_PT,10)# 5 pts
sum(META_data$ethnicity =="HISPANIC OR LATINO")# sum = 5 not sure why
sum(nrow(AFR_PT),nrow(ASIAN_PT),nrow(Other_PT),nrow(CEU_PT),nrow(HIS_PT))
...
write.csv(HIS_PT, file = "/Volumes/home/greally-lab/T_Trial/TCGA_data_CRC/Hispanic_meta_CRC.csv")
dim(CEU_PT) 
#296 76
...
```{r}
##########################Meta data numbers for inporatnt information######################
...
View(OB_AFR_short)
European_super_table = merge(x = OB_EUR_short, y= META_data, by= "bcr_patient_barcode" ,all.x = T, all.y = F) 
African_super_table = merge(x = OB_AFR_short, y= META_data, by = "bcr_patient_barcode" ,all.x = T, all.y = F) 

str(African_super_table)
levels(African_super_table$stage_event_pathologic_stage)
sum(European_super_table$stage_event_pathologic_stage=="Stage IV" | European_super_table$stage_event_pathologic_stage == "Stage IVA" | European_super_table$stage_event_pathologic_stage == "Stage IVB"| European_super_table$stage_event_pathologic_stage == "Stage IVC", na.rm = T)
sum(European_super_table$stage_event_pathologic_stage == "", na.rm = T)
levels(European_super_table$stage_event_pathologic_stage)
...
#########Tumor location#############
levels(European_super_table$anatomic_neoplasm_subdivision)
sum(European_super_table$anatomic_neoplasm_subdivision == "Ascending Colon" | European_super_table$anatomic_neoplasm_subdivision == "Transverse Colon" | European_super_table$anatomic_neoplasm_subdivision == "Hepatic Flexure" | European_super_table$anatomic_neoplasm_subdivision == "Cecum")
# proximal 88

sum(European_super_table$anatomic_neoplasm_subdivision == "Descending Colon" | European_super_table$anatomic_neoplasm_subdivision == "Sigmoid Colon" | European_super_table$anatomic_neoplasm_subdivision == "Splenic Flexure" | European_super_table$anatomic_neoplasm_subdivision == "Rectum" | European_super_table$anatomic_neoplasm_subdivision == "Rectosigmoid Junction")
#distal 100
sum(European_super_table$anatomic_neoplasm_subdivision == "")
#11 unkown

levels(African_super_table$anatomic_neoplasm_subdivision)
sum(African_super_table$anatomic_neoplasm_subdivision == "Ascending Colon" | African_super_table$anatomic_neoplasm_subdivision == "Transverse Colon" | African_super_table$anatomic_neoplasm_subdivision == "Hepatic Flexure" | African_super_table$anatomic_neoplasm_subdivision == "Cecum", na.rm = T)
# proximal 25

sum(African_super_table$anatomic_neoplasm_subdivision == "Descending Colon" | African_super_table$anatomic_neoplasm_subdivision == "Sigmoid Colon" | African_super_table$anatomic_neoplasm_subdivision == "Splenic Flexure" | African_super_table$anatomic_neoplasm_subdivision == "Rectum" | African_super_table$anatomic_neoplasm_subdivision == "Rectosigmoid Junction", na.rm = T)
#distal 11
sum(African_super_table$anatomic_neoplasm_subdivision == "", na.rm = T)
#2 unkown
```
...
SNVH_data_short <- cbind(SNVH_n_AFR,SNVH_n_CEU[,2:329],SNVH_n_ASIAN[2:14],SNVH_n_Other[,2:242])
...
SNVH_data_short <- read.table(file = "/Volumes/home/greally-lab/T_Trial/SVNH_Named_ordered.txt")
dim(SNVH_data_short)
SNVH_data_short[1:5,1:5]
